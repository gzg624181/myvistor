...
<body>
<div class="formHeader"> <span class="title">用法规则</span> <a href="javascript:location.reload();" class="reload">刷新</a> </div>
<?php
$row=$dosql->GetOne("SELECT * FROM pmw_rules where id=1");
 ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="formTable">
		...
		<tr>
		  ...
		  <td colspan="2">用法规则</td>
    </tr>

<tr>
<td height="40" align="right">规则内容：</td>
