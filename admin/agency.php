  ...
  <tr align="left" class="head">
    <td width="3%" align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
      <tr align="left" class="head">
          ...
          <tr align="left" class="head">
            <td width="3%" height="144" align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="dataTable">
              <tr align="left" class="head" style="font-weight:bold;">
                ...
                <td width="9%" align="center">访客头像</td>
                <td width="17%" align="center">访客昵称</td>
                <td width="14%" align="center">访客性别</td>
                <td width="16%" align="center">访问数量</td>
                <td width="18%" align="center">查看海报内容</td>
                <td width="15%" align="center">最后访问时间</td>
	    ...
	    $dopage->GetPage("SELECT a.id,b.nickname,b.sex,b.images,a.vtime,a.poster_id,a.vistor_openid FROM $tbname a inner join pmw_members b on a.vistor_openid=b.openid where b.nickname like '%$keyword%' group by vistor_openid desc",15);
		}else{
		$dopage->GetPage("SELECT a.id,b.nickname,b.sex,b.images,a.vtime,a.poster_id,a.vistor_openid FROM $tbname a inner join pmw_members b on a.vistor_openid=b.openid group by vistor_openid desc",15);
		}
		...
		?>
              <tr class="dataTr" align="left">
                ...
                <?php
                $one=1;
				$openid=$row['vistor_openid'];
$dosql->Execute("SELECT * FROM $tbname where vistor_openid='$openid'",$one);
$num=$dosql->GetTotalRow($one);
echo $num;
?></td>
                <td align="center" class="num"><a style="cursor:pointer;" href="agency_list.php?openid=<?php echo $row['vistor_openid'];?>" >点击查看</a></td>
